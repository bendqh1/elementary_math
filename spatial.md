...
| Strafe right          | เคลื่อนที่ไปทางขวา       |
| left                  | ทางซ้าย                |
| Turn left             | เลี้ยวซ้าย               |
| Strafe left           | เคลื่อนที่ไปทางซ้าย      |
| Direction             | ทิศทาง                   |
| North                 | ทิศเหนือ                 |
| East                  | ทิศตะวันออก              |
| South                 | ทิศใต้                   |
...
|-------------------------------------------------------------------------|----------------------------------------------------------------------|
| Axis                                                                    | แกน                                       |
| X-axis and Y-axis                                                       | แกน X และแกน Y                            |
| Cartesian coordinate system                                             | ระบบพิกัดคาร์ทีเซียน                      |
| Origin of the Cartesian coordinate system                               | จุดกำเนิดของระบบพิกัดคาร์ทีเซียน          |
